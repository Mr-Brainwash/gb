...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="offset-md-3 col-md-6 col-sm-12 pb-3 mt-3">
			<?php
			if(isset($_GET['id']))
			{
				$id		=	$_GET['id'];
					...
					if(file_exists($image))
					{
						echo '<div class="card">
								...
								<div class="card-body">
									...
									<a href="order.php?id='.$res['id'].'" target="_blank" class="btn btn-outline-success">Добавить в корзину</a>
								</div>
								<div class="card-footer">
									<small class="text-muted">Количество просмотров: '.$res['views_count'].'</small>
								</div>
							</div>';
					}
				}
